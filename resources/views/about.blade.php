    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        ...
        <div class="ms-auto d-flex justify-content-center">
          <a class="btn btn-outline rounded-pill btn-masuk py-2 px-4 me-3" href="{{ route('login') }}" role="button" style="font-size: 18px;">Masuk</a>
          <a class="btn btn-outline rounded-pill btn-daftar py-2 px-4" href="{{ route('register') }}" role="button" style="font-size: 18px;">Daftar</a>
        </div>
      </div>
    </div>
  </nav>
