    ...
    <form action="{{ route('auth.register-umkm') }}" method="post" x-on:submit.prevent="submit" x-ref="form">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6">
                <div x-data="{ showPassword: false }" class="form-password">
                    ...
                    <div class="input-password">
                        <input :type="showPassword ? 'text' : 'password'" name="password_umkm"
            ...
            <div class="col-12 col-md-6">
                <div class="form-no-telp">
                    ...
                    <input type="number" name="phone_number_umkm" placeholder="Masukan no telephone"
        ...
        <div class="form-email">
            ...
            <input type="text" id="npwp" name="npwp" maxlength="20"
                placeholder="Masukan NPWP (ex : 12.312.312.3-213.123)" x-model="form.npwp"
                x-on:blur="validateField('npwp')">
