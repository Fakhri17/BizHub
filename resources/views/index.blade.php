      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-6">
          <div class="text-start">
            ...
            <p style="font-size: 18px;">BizHub merupakan aplikasi berbasis website yang diperuntukan kepada pelaku UMKM untuk dapat memasarkan
        ...
        <div class="col-12 col-lg-4">
          <div class="card rounded-3 shadow">
            <div class="card-body text-center p-4 px-5">
              ...
              <p style="font-size: 16px;">Menampilkan UMKM yang telah mendaftar dan menggunakan platform BizHub untuk memasarkan produk dan layanan mereka.</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-4">
          <div class="card rounded-3 shadow">
            <div class="card-body text-center p-4 px-5">
              ...
              <p style="font-size: 16px;">Pengguna dapat memberikan ulasan dan penilaian terhadap produk dan layanan yang ditawarkan oleh pelaku UMKM</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-4">
          <div class="card rounded-3 shadow">
            <div class="card-body text-center p-4 px-5">
              ...
              <p style="font-size: 16px;">Menyediakan ruang bagi pelaku UMKM untuk berbagi informasi, tips, dan artikel yang berkaitan dengan dunia usaha mikro, kecil, dan menengah</p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="card rounded-4 shadow py-4 position-relative overflow-hidden">
        <div class="card-body text-center p-4 px-5">
          ...
          <p class="my-4" style="font-size: 20px;">Apakah Anda seorang pelaku UMKM yang ingin memperluas jangkauan pasar dan meningkatkan penjualan? BizHub hadir untuk membantu Anda! Dengan BizHub, Anda dapat dengan mudah memasarkan produk dan layanan Anda kepada lebih banyak konsumen secara efektif dan efisien.</p>
